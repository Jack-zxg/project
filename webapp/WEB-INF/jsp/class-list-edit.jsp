        ...
        <form class="layui-form" id="editForm" method="post" action="">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="classId" name="classId" required lay-verify="classId"
          ...
          <!--<div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select class="layui-input" id="majorId" name="majorname">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="startTime" name="timeStart" required lay-verify="required"
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="endTime" name="timeEnd" required lay-verify="required"
