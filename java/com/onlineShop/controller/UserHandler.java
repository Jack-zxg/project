...
public class UserHandler {
    ...
    public String updateUser(@PathVariable("id") Integer id,Map map){
    ...
    public String showAdminList(@RequestParam(defaultValue="1",required=true,value="pageNo") int pageNo,
